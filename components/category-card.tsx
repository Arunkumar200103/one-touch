...
const iconMap: { [key: string]: React.ReactNode } = {
  ...
  "CCTV & Networking": (
    <svg className="w-14 h-14" fill="currentColor" viewBox="0 0 20 20">
      <path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a１ １ ０ ０１１ １v１２a１ １ ０ ０１－１ １h－２a１ １ ０ ０１－１－１V４z" />
    </svg>
  ),
  Furniture: (
    <svg className="w-14 h-14" fill="currentColor" viewBox="0 0 20 20">
